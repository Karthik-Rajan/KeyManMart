                                        ...
                                        <div className="card-block">
                                            <div className="row align-items-center b-b-default">
                                                <div className="col-sm-6 b-r-default p-b-20 p-t-20">
                                                    <div className="row align-items-center text-center">
                                                        <div className="col-4 p-r-0">
                                                            <i className="fas fa-share-alt text-c-purple f-24"></i>
                                                        </div>
                                                        <div className="col-8 p-l-0">
                                                            <h5>1000</h5>
                                                ...
                                                <div className="col-sm-6 p-b-20 p-t-20">
                                                    <div className="row align-items-center text-center">
                                                        <div className="col-4 p-r-0">
                                                            <i className="fas fa-sitemap text-c-green f-24"></i>
                                                        </div>
                                                        <div className="col-8 p-l-0">
                                                            <h5>600</h5>
                                            ...
                                            <div className="row align-items-center">
                                                <div className="col-sm-6 p-b-20 p-t-20 b-r-default">
                                                    <div className="row align-items-center text-center">
                                                        <div className="col-4 p-r-0">
                                                            <i className="fas fa-signal text-c-red f-24"></i>
                                                        </div>
                                                        <div className="col-8 p-l-0">
                                                            <h5>350</h5>
                                                ...
                                                <div className="col-sm-6 p-b-20 p-t-20">
                                                    <div className="row align-items-center text-center">
                                                        <div className="col-4 p-r-0">
                                                            <i className="fas fa-wifi text-c-blue f-24"></i>
                                                        </div>
                                                        <div className="col-8 p-l-0">
                                                            <h5>100%</h5>
                                                ...
                                                <table className="table table-hover m-b-0 without-header">
                                                    <tbody>
                                                        <tr>
                                                            <td>
                                                                <div className="d-inline-block align-middle">
                                                                    <img src="/images/avatar-4.jpg" alt="user image" className="img-radius img-40 align-top m-r-15" />
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div className="d-inline-block align-middle">
                                                                    <img src="/images/avatar-2.jpg" alt="user image" className="img-radius img-40 align-top m-r-15" />
                                                                    <div className="d-inline-block">
                                        ...
                                        <div className="col-md-6">
                                            <div className="card text-center order-visitor-card">
                                                <div className="card-block">
                                                    ...
                                                    <h4 className="m-t-15 m-b-15"><i className="fa fa-arrow-down m-r-15 text-c-red"></i>7652</h4>
                                        ...
                                        <div className="col-md-6">
                                            <div className="card text-center order-visitor-card">
                                                <div className="card-block">
                                                    ...
                                                    <h4 className="m-t-15 m-b-15"><i className="fa fa-arrow-up m-r-15 text-c-green"></i>6325</h4>
                                        ...
                                        <div className="col-md-6">
                                            <div className="card text-center order-visitor-card">
                                                <div className="card-block">
                                                    ...
                                                    <h4 className="m-t-15 m-b-15"><i className="fa fa-arrow-down m-r-15 text-c-red"></i>652</h4>
                                                    <p className="m-b-0">36% From Last 6 Months</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="col-md-6">
                                            <div className="card text-center order-visitor-card">
                                                <div className="card-block">
                                                    ...
                                                    <h4 className="m-t-15 m-b-15"><i className="fa fa-arrow-up m-r-15 text-c-green"></i>5963</h4>
                                                    <p className="m-b-0">36% From Last 6 Months</p>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div className="row">
                                                <div className="col-xl-3 col-md-6">
                                                    ...
                                                    <div className="progress">
                                                        <div className="progress-bar bg-c-red" style={{ width: 25 }}></div>
                                                    </div>
                                                </div>
                                                <div className="col-xl-3 col-md-6">
                                                    ...
                                                    <div className="progress">
                                                        <div className="progress-bar bg-c-blue" style={{ width: 65 }}></div>
                                                    </div>
                                                </div>
                                                <div className="col-xl-3 col-md-6">
                                                    ...
                                                    <div className="progress">
                                                        <div className="progress-bar bg-c-green" style={{ width: 85 }}></div>
                                                    </div>
                                                </div>
                                                <div className="col-xl-3 col-md-6">
