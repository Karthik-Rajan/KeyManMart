        ...
        <nav className="navbar header-navbar pcoded-header" >
            <div className="navbar-wrapper">
                <div className="navbar-logo">
                    ...
                    <a href="#">
                        <img className="img-fluid" src="/images/logo.png" alt="Theme-Logo" />
                    </a>
                ...
                <div className="navbar-container container-fluid">
                    ...
                    <ul className="nav-right">
                        <li className="header-notification">
                            ...
                            <ul className="show-notification">
                                ...
                                <li className="waves-effect waves-light">
                                    <div className="media">
                                        <img className="d-flex align-self-center img-radius" src="/images/avatar-2.jpg" alt="Generic placeholder image" />
                                ...
                                <li className="waves-effect waves-light">
                                    <div className="media">
                                        <img className="d-flex align-self-center img-radius" src="/images/avatar-4.jpg" alt="Generic placeholder image" />
                                        <div className="media-body">
                                ...
                                <li className="waves-effect waves-light">
                                    <div className="media">
                                        <img className="d-flex align-self-center img-radius" src="/images/avatar-3.jpg" alt="Generic placeholder image " />
                                        <div className="media-body">
                        ...
                        <li className="user-profile header-notification">
                            <a href="#!" className="waves-effect waves-light">
                                <img src="/images/avatar-4.jpg" className="img-radius" alt="User-Profile-Image" />
                                <span>John Doe</span>
